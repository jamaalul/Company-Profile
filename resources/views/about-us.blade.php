        ...
        <main class="container main-content">
            <section class="hero-section text-center mt-5" style="margin-top: 120px !important;" data-aos="fade-up">
                ...
                <div class="team-photo" data-aos="zoom-in" data-aos-delay="300">
                    <img src="http://127.0.0.1:8000/images/about/KADEP-HIMTI.png" alt="HIMTI Structure Team"
                        class="img-fluid">
                </div>
            </section>
            ...
            <section class="kahima-section" data-aos="fade-up">
                <div class="row">
                    <div class="col-md-3" data-aos="fade-right" data-aos-delay="200">
                        <img src="http://127.0.0.1:8000/images/about/Kahima.png" alt="Muhammad Zaky"
                    ...
                    <div class="col-md-9" data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div class="profile-card">
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed consectetur odio sem, in
                                pharetra turpis
                                faucibus in. Phasellus fringilla ultricies ullamcorper. Pellentesque gravida nisl nunc, id
                                laoreet urna
                                pulvinar vel. Interdum et malesuada fames ac ante ipsum primis in faucibus. In dictum sit
                                amet nunc vel
                                pharetra. Curabitur facilisis ex vitae blandit consectetur. Donec ut facilisis nisl, vitae
                                pretium arcu.
                                In congue purus eleifend risus hendrerit, eu finibus lectus eleifend.
                            </p>
                            <p>
                                Nulla nec libero tortor. Fusce vehicula quam risus, nec tempus turpis luctus vel. Fusce eros
                                diam,
            ...
            <section class="wakahima-section" data-aos="fade-up">
                <div class="row">
                    ...
                    <div class="col-md-3" data-aos="fade-left" data-aos-delay="200">
                        <img src="http://127.0.0.1:8000/images/about/Wakahima.png" alt="Fitria Indah Novitasari"
                            class="profile-image img-fluid">
                    </div>
                </div>
            </section>
                            ...
                            <a href="{{ url('/about-us/' . $department->slug) }}" class="program-link">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        ...
                                        <img src="{{ asset($department->leadership_photo) }}" alt="{{ $department->name }}"
                                            class="program-image">
                                    </div>
