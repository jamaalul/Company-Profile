...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('admin.news.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors">
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-gray-600">Public News</p>
                <p class="text-2xl font-semibold text-gray-900">{{ $news->where('type', 'public')->count() }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-gray-600">Internal News</p>
                <p class="text-2xl font-semibold text-gray-900">{{ $news->where('type', 'internal')->count() }}</p>
            </div>
        </div>
    </div>
</div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-16 w-16">
                                <img class="h-16 w-16 rounded-lg object-cover" 
                                     src="{{ $article->featured_image ? asset('storage/' . $article->featured_image) : '/placeholder.svg?height=64&width=64' }}" 
                                     alt="{{ $article->title }}">
                            </div>
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900 line-clamp-2">{{ $article->title }}</div>
                                <div class="text-sm text-gray-500 line-clamp-1">{{ Str::limit($article->excerpt, 60) }}</div>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $article->type === 'public' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800' }}">
